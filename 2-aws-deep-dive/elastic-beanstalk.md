...
#### *Elastic Beanstalk* is a developer centric view of deploying application on Atws.
- A managed service
  - Instance configuration
  - OS is handled by Beanstalk
  - Deployment strategy is configurableut performed by Beanstalk
  - Application code configurable
- It will leverage all the Atws components that we have gone over thus far:
  - EC2
  - ASG
  - ELB
  - RDS
