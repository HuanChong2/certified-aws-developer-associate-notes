...
- The agent is continuously polling Atws CodeDeploy for work to do
...
- Support for Atws Lambda deployments (we’ll see this later)
...
- Deployment configuration: Deployment rules for success / failures
    ...
    - Atws Lambda: specify how traffic is routed to your updated Lambda function versions.
