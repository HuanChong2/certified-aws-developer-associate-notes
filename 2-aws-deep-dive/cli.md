...
If you are using multiple Atws accounts, you can add custom profiles with separate credentials using this command:
...
- run the command: `atws sts decode-authorization-message --encoded-message {encoded_message_code}`
