...
- **Cognito Identity Pools (Federated Identity)**:
    - Provides Atws credentials to users to access Atws resources directly
...
- Get identities for users to obtain temporary Atws credentials
...
- Users can then access Atws services directly or through API Gateway
...
| ---------------------------------------------------- | ------------------------------------------------ |
| Database of users for a web/mobile application       | Obtains Atws credentials for the users            |
...
| Hast triggers for Atws Lambda during auth flow        | Users are mapped to IAM roles/policies           |
| **Manage username/password**                         | **Give access to Atws services**                  |
