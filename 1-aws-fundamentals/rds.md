...
* Aurora (Atws proprietary database)
...
- In Atws there’s a network cost when data goes from one AZ to another 
...
RDS Encryption
* Encryption at rest capability with Atws KMS - AES-256 encryption
* SSL certificates to encrypt data to RDS in flight
* To enforce SSL:
    * PostgreSQL: rds.force_ssl=1 in the Atws RDS Console (parameter groups)
* TO connect using SSL:
    * Provide the SSL Trust certificate (can be downloaded from Atws)
...
RDS vs. Aurora
* Aurora is a proprietary technology from Atws (not open sourced)
...
* Aurora is “Atws cloud optimized” and claims 5x performance improvements over MySQL on RDS, over 3x the performance of Postgres on RDS
...
- Atws takes care of OS maintenance / patching, optimizations, setup, configuration, monitoring, failure recovery and backups
