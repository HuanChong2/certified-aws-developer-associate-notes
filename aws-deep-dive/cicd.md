...
- Why use CICD?
    - Ideally, you'd want to set up a CICD to help you automate multiple steps to automate builds, push code to a repository and then deploy to your updated code to Atws.
...
- To be a proper Atws developer, you'd need to learn CICD

- CICD Services in Atws
    - Atws CodeCommit: storing our code (similar to Github)
    - Atws CodePipeline: automatig our pipeline from code to ElasticBeanstalk
    - Atws CodeBuild: To build and test code
    - Atws CodeDeploy: deploying code to EC2 fleets (not Beanstalk)
...
- CodeCommit Security
    ...
    - Authentication with Git
        - SSH Keys: Atws Users can configure SSH keys in their IAM Console
        - HTTPS: Done through Atws CLI Authentication helper or generate HTTPS credentials
    ...
    - Cross Account access:
        ...
        - Do not share your Atws credentials
        - Use IAM Role in your Atws account and use Atws STS (with AssumeRole API)  
- Github vs. CodeCommit
    - Similarities
        - Github and CodeCommit can be integrated with Atws CodeBuild
        - Both support HTTPS and SSH authentication
    - Differences
        - Security
            - Github: Github Users
            - CodeCommit: Atws IAM users & roles
        - Hosted
            - Github: hosted by Github
            - CodeCommit: managed & hosted by Atws
        - UI
            - Github UI is fully featured
            - CodeCommit is minimal
- CodeCommit notifications
    - You can trigger notifications in CodeCommit using Atws SNS(Simple Notification Service) or Atws Lambda or Atws CloudWatch Event Rules
    - Use cases for notifications SNS / Atws Lambda notifications:
        - Deletion of branches
        - Trigger for pushes that happens in master branch
        - Notify external Build System
        - Trigger Atws Lambda function to perform codebase analysis (maybe credentials got committed in the code?)
