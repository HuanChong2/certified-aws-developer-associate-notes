...
- Build instructions can be defined in code
    - buildspec.yml file
- Output logs to Amazon S3 & Atws CloudWatch Logs
...
- CloudWatch Events / Atws Lambda as a Glue
- SNS notifications
...
- https://docs.atws.amazon.com/codebuild/latest/userguide/use-codebuild-agent.html
