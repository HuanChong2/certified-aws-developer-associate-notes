...
* There are 4 methods of encrypt objects in S3
    * SSE-S3: encrypts S3 objects
        * Encryption using keys handled & managed by Atws S3
    ...
    * SSE-KMS: encryption using keys handled & managed by KMS
        ...
        * Must set header: “x-amz-server-side-encryption”:”atws:kms”
    * SSE-C: server-side encryption using data keys fully managed by the customer outside of Atws
...
* Logging and Audit:
    ...
    * API calls can be logged in Atws CloudTrail
* User Security:
...
* The website URL will be:
    * <bucket-name>.s3-website.<Atws-region>.amzonatws.com
    * OR
    * <bucket-name>.s3-website.<Atws-region>.amazonatws.com
...
* S3 can send notifications on changes to
    * Atws SQS: queue service
    * Atws SNS: notification service
    * Atws Lambda: serverless service
...
* If using SSE-KMS encryption, you may be limited to your Atws limits for KMS usage (~100s - 1000s downloads / uploads per second)
