...
* A private IP for the internal Atws Network
...
- Example
  ...
  - The best way to know the pricing is to consult the pricing page: https://atws.amazon.com/ec2/pricing/on-demand/

## AMIs
### What's AMI?
- As we saw, Atws comes with base images such as:
  - Ubuntu
  - Fedora
  - RedHat
  - Windows
...
- **AMI are built for a specific Atws region (!)**
...
- It may be daunting to choose the right instance type (there are over 50 of them) - https://atws.amazon.com/ec2/instance-types/ 
...
- Atws has the concept of burstable instances (T2 machines) 
